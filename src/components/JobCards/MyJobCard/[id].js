...
const MyJobCardsId = () => {
  ...
  const [finalSubArrayList, setFinalSubArrayList] = useState()
        ...
        bg-[#FFFFFF] rounded-[31.53px]" style={{overflow: 'auto'}}>
          ...
          <div className="ml-[95px]">
            <table className="table-auto pt-[24px]" style={{overflow: 'auto'}}>
              ...
              {/* {finalSubArrayList && finalSubArrayList.sort(sortTypes[currentSort].fn)?.map((item, ids) => { */}
              {finalSubArrayList && finalSubArrayList?.map((item, ids) => {
