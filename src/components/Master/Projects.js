          ...
          <div className="flex space-x-[27.92px] self-center">
            <div className="bg-[#F4F7FE] w-[68.28px] flex items-center justify-center h-[68.28px]  rounded-full">
              <img
                ...
                height="44px"
                className="content-center"
>>>>>>> 41fed41c1a35c06d6f123e3dcd4da3d4ff3c3d5d
              />
            </div>
        ...
        <div className="pl-[80px]">
          <table className="table-auto pt-[24px]">
            <thead className="font-secondaryFont text-[#000000] font-normal not-italic text-[12px] leading-[20px] tracking-[-2%] py-[36px] ">
              <tr className="max-h-[53.84px] w-[901.2px]">
                <th className="">Name</th>
                <th className="pl-[140px] py-[15px]">Client</th>
                <th className="pl-[140px] ">Start Date</th>
                <th className="pl-[140px]">End Date</th>
        ...
        <table className="table-auto pt-[24px]">
          <thead className="font-secondaryFont text-[#000000] font-normal not-italic text-[12px] leading-[20px] tracking-[-2%] py-[36px] ">
            <tr className="max-h-[52.84px] w-[901.2px]">
              <th className="px-[10px] py-[13px]">Name</th>
              <th className="px-[90px] py-[13px]">Client</th>
              <th className="px-[70px] py-[13px]">Start Date</th>
              <th className="px-[70px] py-[13px]">End Date</th>
              <th className="px-[90px] py-[13px]">Actions</th>
            </tr>
          </thead>
          <tbody className="font-secondaryFont bg-[#ECF1F0] text-[#000000] font-normal not-italic text-[12px] leading-[20px] tracking-[-2%]">
            <tr>
              ...
              <th className="px-[10px] py-[13px]">Client</th>
              <th className="px-[70px] py-[13px]">Start Date</th>
              <th className="px-[70px] py-[13px]">End Date</th>
              <th className="px-[90px] py-[13px]">
                <div className="flex flex-row space-x-xl">
                  <div>
                    <svg
                      width="19"
