  ...
  return (
    <div className=" flex flex-col max-w-[1099px] mh-[632.01px] bg-[#FFFFFF] py-[50px] px-[50px]">
      ...
      <div className="flex flex-row space-x-sm justify-end items-center mt-[10px] bg-[#FFFFFF]">
        <div
          style={{ boxShadow: "0px 4px rgba(0, 0, 0, 0.25)" }}
          className="flex items-center space-x-sm px-2 rounded"
        >
          <svg
            width="14"
            height="14"
        ...
        <table className="table-auto pt-[24px]">
          <thead className="font-secondaryFont text-[#000000] font-normal not-italic text-[12px] leading-[20px] tracking-[-2%] py-[36px] ">
            <tr className="max-h-[52.84px] w-[901.2px]">
              <th className="px-[10px] py-[13px]">Logo</th>
              <th className="px-[90px] py-[13px]">Name</th>
              <th className="px-[90px] py-[13px]">Location</th>
              <th className="px-[90px] py-[13px]">Category</th>
