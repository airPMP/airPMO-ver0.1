...
export class PermissionsSeeder implements Seeder {
  ...
  async seed(): Promise<any> {
    return await this.PermissionModel.insertMany([
      ...
      {
        name: 'CREATE-USER_ROLES',
        description: 'add user role endpoint access',
      },
      {
        name: 'EDIT-USER_ROLES',
        description: 'edit user role  endpoint access',
      },
      { name: 'GET-USER_ROLES', description: 'get user role endpoint access' },
      {
        name: 'DELETE-USER_ROLES',
        description: 'remove user role endpoint access',
      },

      {
        name: 'CREATE-PERMISSIONS',
        description: 'add permission endpoint access',
      },
      {
        name: 'EDIT-PERMISSIONS',
        description: 'edit permission endpoint access',
      },
      {
        name: 'GET-PERMISSIONS',
        description: 'get permission endpoint access',
      },
      {
        name: 'DELETE-PERMISSIONS',
        description: 'remove permission endpoint access',
      },

      {
        name: 'CREATE-CATEGORIES',
        description: 'add categories endpoint access',
      },
      {
        name: 'EDIT-CATEGORIES',
        description: 'edit categories endpoint access',
      },
      { name: 'GET-CATEGORIES', description: 'get categories endpoint access' },
      {
        name: 'DELETE-CATEGORIES',
        description: 'remove categories endpoint access',
      },
...

      {
        ...
        description: 'add organization endpoint access',
      },
      {
        name: 'EDIT-ORGANIZATION',
        description: 'edit organization endpoint access',
      },
      {
        name: 'GET-ORGANIZATION',
        description: 'get organization endpoint access',
      },
      {
        name: 'DELETE-ORGANIZATION',
        description: 'remove organization endpoint access',
      },
      ...
      { name: 'GET-PROJECTS', description: 'get projects endpoint access' },
      {
        ...
        description: 'remove projects endpoint access',
      },
      ...
      {
        name: 'DELETE-SUBZONES',
        description: 'remove sub zones endpoint access',
      },

      {
        name: 'CREATE-SUB_DIVIDED_ZONES',
        description: 'add sub divided zones endpoint access',
      },
      {
        name: 'EDIT-SUB_DIVIDED_ZONES',
        description: 'edit sub divided zones endpoint access',
      },
      {
        name: 'GET-SUB_DIVIDED_ZONES',
        description: 'get sub divided zones endpoint access',
      },
      {
        name: 'DELETE-SUB_DIVIDED_ZONES',
        description: 'remove sub divided zones endpoint access',
      },
      ...
      { name: 'DELETE-MY-JOB-CARD', description: 'edit my job card' },
    ]);
  }
